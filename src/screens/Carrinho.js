...
const CartScreen = ({ navigation }) => {
        ...
        const handleCheckout = async () => {
            try {
                ...
                if (isLoggedIn === "true") {
                    ...
                    Alert.alert("Atenção", "Você precisa estar logado para finalizar a compra.", [
                ...
                <View style={styles.itemDetails}>
                    <View style={styles.itemActions}>
                        ...
                        <TouchableOpacity onPress={() => handleRemoveItem(item)}>
                            <MaterialIcon name="delete-outline" size={24} color="#e74c3c" style={styles.actionIcon} />
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={styles.quantityArea}>
                        <View style={styles.quantityContainer}>
                            <TouchableOpacity onPress={() => handleQuantityChange(item.id, 1)} style={styles.qtyButton}>
                            ...
                            <TouchableOpacity
                                onPress={() =>
                                    item.quantity > 1 ? handleQuantityChange(item.id, -1) : handleRemoveItem(item)
                                }
    ...
    const itemCountText = cartItems.length === 1 ? "1 item" : `${cartItems.length} itens`;
    ...
    return (
        <View style={styles.container}>
            ...
            <Modal animationType="fade" transparent={true} visible={isModalVisible} onRequestClose={cancelRemoval}>
                <View style={modalStyles.centeredView}>
                    <View style={modalStyles.modalView}>
                        <Text style={modalStyles.modalTitle}>Remover Item</Text>
                        <Text style={modalStyles.modalText}>Tem certeza que deseja remover este item do carrinho?</Text>
