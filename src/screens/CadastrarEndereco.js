  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.scrollContent}>
      ...
      <View style={styles.formContainer}>
        <TextInput style={styles.input} placeholder="CEP" placeholderTextColor="#666" />
        <TextInput style={styles.input} placeholder="Endereço" placeholderTextColor="#666" />
        <TextInput style={styles.input} placeholder="Número" placeholderTextColor="#666" />
        <TextInput style={styles.input} placeholder="Complemento (opcional)" placeholderTextColor="#666" />
        <TextInput style={styles.input} placeholder="Bairro" placeholderTextColor="#666" />
        <TextInput style={styles.input} placeholder="Cidade" placeholderTextColor="#666" />
        ...
        >
          <Text style={{ color: estado ? "#001f3f" : "#666" }}>
